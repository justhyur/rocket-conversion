  ...
  return (<>
    <section id="mistakes1" className="section">
        ...
        <div className="container">
          <p>Working as a Business analyst for the past 5 years, I&aposve learned that most
          ...
          knowing exactly what to do, then your business it&aposs not going to reach
          its full potential in terms of sales and profits.</p>
          <p>Far from it, in fact.</p>
          <p>After analyzing and optimizing dozens of online businesses I&aposve noticed
    ...
    <section id="mistakes2" className="section">
        <div className="box red">
          ...
          <ul>
            ...
            <li>Their product pages <strong>don&apost include all of the crucial, must-have sales elements.</strong></li>
            <li>They don&apost offer a great and <strong>effortless mobile shopping experience.</strong></li>
          </ul>
        </div>
        <div className="container">
        ...
        <div className="margined">
          <Testimonial
            ...
            customers what&aposs their current status and what they need to do! I LOVE IT!"
        ...
        <div className="box black">
          ...
          <p>Here&aposs a crazy thing:</p>
          <p>Almost every store I&aposve audited recently seemed to be facing the exact same problem:</p>
          ...
          <p>All of these store owners (or their teams) were spending hundreds
            ...
            single year — without fail! — it&aposs been getting more and more
        ...
        <div className="margined">
          <SpecialTitle 
            ...
            customers&apos CLTV and decrease
            CPA"
          />
        ...
        />
          ...
          <p>With a properly set up structure you&aposre going to see a sharp
        ...
        <div className="margined m">
          ...
          <div className="container m margin-auto">
            ...
            listand you&aposre left with a useless and difficult-to-understand checklist,
            then you are no closer to your goals than you were before</p>
            <p><strong>Instead, I&aposve made it my mission to make things as clear as possible
            for you.</strong></p>
          </div>
        </div>
        <div className="box white">
          ...
          <ul>
            ...
            <li><strong>Increase your customers&apos retention rate and CLTV</strong></li>
            <li><strong>Skyrocket your Profit.</strong></li>
          </ul>
          <p>With my Rocket Conversion list you&aposll be able to drill down into every
        ...
        <div className="margined m">
          ...
          />
          <div className="container m margin-auto">
            <p>As I mentioned above, I&aposve analysed and optimized dozens of stores. I&aposve
            helped <strong>online store owners bring in 6 figures of additional profits in the
            last year alone.</strong></p>
            <p>I&aposm a deeply analytical guy at heart and during all of my 5+ years in this
            industry, I&aposve remained obsessed with what truly works and what doesn&apost
            ...
            — and I&aposm happy to share all of this knowledge and experience with you.</p>
          </div>
        </div>
          <SpecialTitle 
            h={3}
            title="“Alright, I&aposm sold — how does
            this work?”"
          />
          <div className="numbered-list">
            <ul>
              ...
              <li><span>4</span>Once you&aposre done with your tasks, start enjoying looking at the increased revenue that my list brought to you.</li>
            </ul>
          </div>
